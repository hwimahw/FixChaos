package ru.dhabits.fixchaos.planning.inbound.rest.shorttermgoal;

import com.dhabits.code.fixchaos.planning.controller.ShortTermGoalApi;
...
import ru.dhabits.fixchaos.planning.inbound.rest.shorttermgoal.createshorttermgoal.mapper.CreateShortTermGoalMapper;
import ru.dhabits.fixchaos.planning.inbound.rest.shorttermgoal.getallshorttermgoals.GetAllShortTermGoalsMapper;
import ru.dhabits.fixchaos.planning.inbound.rest.shorttermgoal.getshorttermgoal.GetShortTermGoalMapper;
import ru.dhabits.fixchaos.planning.inbound.rest.shorttermgoal.updateshorttermgoal.UpdateShortTermGoalMapper;
import ru.dhabits.fixchaos.planning.usecase.shorttermgoal.createshorttermgoal.CreateShortTermGoalUseCase;
import ru.dhabits.fixchaos.planning.usecase.shorttermgoal.deleteshorttermgoal.DeleteShortTermGoalUseCase;
import ru.dhabits.fixchaos.planning.usecase.shorttermgoal.getallshorttermgoals.GetAllShortTermGoalsUseCase;
import ru.dhabits.fixchaos.planning.usecase.shorttermgoal.getshorttermgoal.GetShortTermGoalUseCase;
import ru.dhabits.fixchaos.planning.usecase.shorttermgoal.getshorttermgoal.response.ShortTermGoalInfo;
import ru.dhabits.fixchaos.planning.usecase.shorttermgoal.updateshorttermgoal.UpdateShortTermGoalUseCase;
