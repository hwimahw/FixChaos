package ru.dhabits.fixchaos.planning.inbound.rest.longtermgoal;

import com.dhabits.code.fixchaos.planning.controller.LongTermGoalApi;
...
import ru.dhabits.fixchaos.planning.inbound.rest.longtermgoal.createlongtermgoal.mapper.CreateLongTermGoalMapper;
import ru.dhabits.fixchaos.planning.inbound.rest.longtermgoal.getalllongtermgoals.GetAllLongTermGoalsMapper;
import ru.dhabits.fixchaos.planning.inbound.rest.longtermgoal.getlongtermgoal.GetLongTermGoalMapper;
import ru.dhabits.fixchaos.planning.inbound.rest.longtermgoal.updatelongtermgoal.UpdateLongTermGoalMapper;
import ru.dhabits.fixchaos.planning.usecase.longtermgoal.createlongtermgoal.CreateLongTermGoalUseCase;
import ru.dhabits.fixchaos.planning.usecase.longtermgoal.deletelongtermgoal.DeleteLongTermGoalUseCase;
import ru.dhabits.fixchaos.planning.usecase.longtermgoal.getalllongtermgoals.GetAllLongTermGoalsUseCase;
import ru.dhabits.fixchaos.planning.usecase.longtermgoal.getshorttermgoal.GetLongTermGoalUseCase;
import ru.dhabits.fixchaos.planning.usecase.longtermgoal.getshorttermgoal.response.LongTermGoalInfo;
import ru.dhabits.fixchaos.planning.usecase.longtermgoal.updatelongtermgoal.UpdateLongTermGoalUseCase;
